...
static CONST gattAttrType_t testService2 = { ATT_BT_UUID_SIZE, TestServiceUUID };

static gattAttribute_t TestAttrTbl2[] = 
{
         /* test service */
        { 
                { ATT_BT_UUID_SIZE, primaryServiceUUID }, /* type */
...
bStatus_t test_InitService( uint32 services )
{
  uint8 status = SUCCESS;
    ...
    status = GATTServApp_RegisterService( TestAttrTbl2, GATT_NUM_ATTRS( TestAttrTbl2 ), &testProfileCBs);
